...
try {
    $conn = new PDO("sqlsrv:server = tcp:dicodingkotabpn.database.windows.net,1433; Database = dicodingbpn", "dicodingbpn", "{your_password_here}");
...
$connectionInfo = array("UID" => "dicodingbpn@dicodingkotabpn", "pwd" => "{your_password_here}", "Database" => "dicodingbpn", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
